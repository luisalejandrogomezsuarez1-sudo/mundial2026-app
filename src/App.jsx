...
:root{
  ...
  --glow:0 0 24px rgba(var(--gold-rgb),.22);
}
body{font-family:var(--fb);background:var(--bg);color:var(--txt);height:100%;overflow:hidden;}
.app{max-width:430px;margin:0 auto;height:100dvh;overflow:hidden;display:flex;flex-direction:column;position:relative;isolation:isolate;
  background:
...
.scr{flex:1;overflow-y:auto;overflow-x:hidden;padding-bottom:calc(84px + env(safe-area-inset-bottom));}
.scr::-webkit-scrollbar{display:none;}
.bnav{position:absolute;bottom:0;left:0;right:0;height:76px;
  background:rgba(6,14,28,0.97);border-top:1px solid rgba(var(--gold-rgb),0.12);
  display:flex;align-items:center;justify-content:space-around;
  padding:0 4px calc(6px + env(safe-area-inset-bottom));z-index:100;backdrop-filter:blur(28px);
...
.nitem.on{background:rgba(var(--gold-rgb),0.08);}
...
.inp:focus{border-color:var(--gold);box-shadow:0 0 0 3px rgba(var(--gold-rgb),.1);}
.inp::placeholder{color:var(--muted);}
.btn{width:100%;background:linear-gradient(135deg,var(--gold),var(--gold2));
...
.btn:hover{opacity:.92;transform:translateY(-1px);box-shadow:0 6px 24px rgba(var(--gold-rgb),.45);}
...
.tpill.on{background:rgba(var(--gold-rgb),.12);color:var(--gold);border-color:rgba(var(--gold-rgb),.4);}
...
.mc:hover{transform:scale(1.015);border-color:rgba(var(--gold-rgb),.4);
  box-shadow:
...
const NEXT_MATCHES=[
  ...
  {id:53, home:'República Checa',     away:'México',              isoDate:'2026-06-24',date:'Jun 24',time:'19:00',phase:'Grupo A · J3',venue:'Estadio Azteca',                  city:'Tlalpan, CDMX',        wx:{ic:'⛅',desc:'Noche fresca',t:'16°C'},        odds:[4.5,3.5,1.7]},
  {id:54, home:'Sudáfrica',           away:'Corea del Sur',       isoDate:'2026-06-24',date:'Jun 24',time:'19:00',phase:'Grupo A · J3',venue:'Estadio Monterrey',               city:'Guadalupe, Monterrey', wx:{ic:'⛅',desc:'Cálido',t:'28°C'},             odds:[3.5,3.2,2.1]},
  // Jue 25 Jun
  ...
  {id:56, home:'Ecuador',             away:'Alemania',            isoDate:'2026-06-25',date:'Jun 25',time:'14:00',phase:'Grupo E · J3',venue:'New York New Jersey Stadium',     city:'East Rutherford, NJ',  wx:{ic:'🌤️',desc:'Agradable',t:'24°C'},         odds:[7.0,4.5,1.4]},
  ...
  {id:85, home:'Por definir',away:'Por definir',isoDate:'2026-07-02',date:'Jul 2', time:'21:00',phase:'16avos · P85', venue:'BC Place',                       city:'Vancouver, BC',        wx:{ic:'⛅',desc:'',t:'--'},odds:[2.0,3.2,3.0]},
...
const LIGAMX_MATCHES=[
  {id:1001, home:'Necaxa', away:'Atlante', isoDate:'2026-07-16', date:'Jul 16', time:'19:00', phase:'Apertura · J1', venue:'Estadio Victoria', city:'Aguascalientes'},
  {id:1002, home:'Tijuana', away:'Tigres', isoDate:'2026-07-16', date:'Jul 16', time:'21:00', phase:'Apertura · J1', venue:'Estadio Caliente', city:'Tijuana'},
  {id:1003, home:'Atl. San Luis', away:'Cruz Azul', isoDate:'2026-07-17', date:'Jul 17', time:'19:00', phase:'Apertura · J1', venue:'Estadio Alfonso Lastras', city:'San Luis Potosí'},
  {id:1004, home:'León', away:'Atlas', isoDate:'2026-07-17', date:'Jul 17', time:'19:00', phase:'Apertura · J1', venue:'Estadio León', city:'León, Guanajuato'},
  {id:1005, home:'FC Juárez', away:'Puebla', isoDate:'2026-07-17', date:'Jul 17', time:'21:00', phase:'Apertura · J1', venue:'Estadio Olímpico Benito Juárez', city:'Ciudad Juárez'},
  {id:1006, home:'Pumas', away:'Pachuca', isoDate:'2026-07-18', date:'Jul 18', time:'17:00', phase:'Apertura · J1', venue:'Estadio Olímpico Universitario', city:'CDMX'},
  {id:1007, home:'Monterrey', away:'Santos Laguna', isoDate:'2026-07-18', date:'Jul 18', time:'19:00', phase:'Apertura · J1', venue:'Estadio BBVA', city:'Guadalupe, NL'},
  {id:1008, home:'Chivas', away:'Toluca', isoDate:'2026-07-18', date:'Jul 18', time:'19:07', phase:'Apertura · J1', venue:'Estadio Akron', city:'Zapopan, Jalisco'},
  {id:1009, home:'Querétaro', away:'América', isoDate:'2026-07-18', date:'Jul 18', time:'21:00', phase:'Apertura · J1', venue:'Estadio Corregidora', city:'Querétaro'},
  {id:1010, home:'Cruz Azul', away:'Puebla', isoDate:'2026-07-21', date:'Jul 21', time:'19:00', phase:'Apertura · J2', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1011, home:'Toluca', away:'Pumas', isoDate:'2026-07-21', date:'Jul 21', time:'21:00', phase:'Apertura · J2', venue:'Estadio Nemesio Diez', city:'Toluca'},
  {id:1012, home:'Tigres', away:'Atl. San Luis', isoDate:'2026-07-24', date:'Jul 24', time:'19:00', phase:'Apertura · J2', venue:'Estadio Universitario', city:'San Nicolás de los Garza'},
  {id:1013, home:'Tijuana', away:'León', isoDate:'2026-07-24', date:'Jul 24', time:'21:00', phase:'Apertura · J2', venue:'Estadio Caliente', city:'Tijuana'},
  {id:1014, home:'Atlante', away:'América', isoDate:'2026-07-24', date:'Jul 24', time:'21:00', phase:'Apertura · J2', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1015, home:'Chivas', away:'FC Juárez', isoDate:'2026-07-25', date:'Jul 25', time:'17:00', phase:'Apertura · J2', venue:'Estadio Akron', city:'Zapopan, Jalisco'},
  {id:1016, home:'Santos Laguna', away:'Atlas', isoDate:'2026-07-25', date:'Jul 25', time:'21:00', phase:'Apertura · J2', venue:'Estadio Corona', city:'Torreón'},
  {id:1017, home:'Necaxa', away:'Monterrey', isoDate:'2026-07-26', date:'Jul 26', time:'17:00', phase:'Apertura · J2', venue:'Estadio Victoria', city:'Aguascalientes'},
  {id:1018, home:'Pachuca', away:'Querétaro', isoDate:'2026-07-26', date:'Jul 26', time:'19:00', phase:'Apertura · J2', venue:'Estadio Hidalgo', city:'Pachuca'},
  {id:1019, home:'Puebla', away:'Chivas', isoDate:'2026-07-31', date:'Jul 31', time:'19:00', phase:'Apertura · J3', venue:'Estadio Cuauhtémoc', city:'Puebla'},
  {id:1020, home:'FC Juárez', away:'Pumas', isoDate:'2026-07-31', date:'Jul 31', time:'21:00', phase:'Apertura · J3', venue:'Estadio Olímpico Benito Juárez', city:'Ciudad Juárez'},
  {id:1021, home:'Atl. San Luis', away:'Tijuana', isoDate:'2026-07-31', date:'Jul 31', time:'21:00', phase:'Apertura · J3', venue:'Estadio Alfonso Lastras', city:'San Luis Potosí'},
  {id:1022, home:'Querétaro', away:'Tigres', isoDate:'2026-08-01', date:'Ago 1', time:'17:00', phase:'Apertura · J3', venue:'Estadio Corregidora', city:'Querétaro'},
  {id:1023, home:'Atlas', away:'Monterrey', isoDate:'2026-08-01', date:'Ago 1', time:'19:00', phase:'Apertura · J3', venue:'Estadio Jalisco', city:'Chivas'},
  {id:1024, home:'León', away:'Pachuca', isoDate:'2026-08-01', date:'Ago 1', time:'19:00', phase:'Apertura · J3', venue:'Estadio León', city:'León, Guanajuato'},
  {id:1025, home:'Cruz Azul', away:'Atlante', isoDate:'2026-08-01', date:'Ago 1', time:'21:00', phase:'Apertura · J3', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1026, home:'América', away:'Santos Laguna', isoDate:'2026-08-02', date:'Ago 2', time:'17:00', phase:'Apertura · J3', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1027, home:'Toluca', away:'Necaxa', isoDate:'2026-08-02', date:'Ago 2', time:'19:00', phase:'Apertura · J3', venue:'Estadio Nemesio Diez', city:'Toluca'},
  {id:1028, home:'Atlante', away:'Toluca', isoDate:'2026-08-15', date:'Ago 15', time:'17:00', phase:'Apertura · J4', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1029, home:'Monterrey', away:'FC Juárez', isoDate:'2026-08-15', date:'Ago 15', time:'19:00', phase:'Apertura · J4', venue:'Estadio BBVA', city:'Guadalupe, NL'},
  {id:1030, home:'Atlas', away:'Tigres', isoDate:'2026-08-15', date:'Ago 15', time:'21:00', phase:'Apertura · J4', venue:'Estadio Jalisco', city:'Chivas'},
  {id:1031, home:'Pumas', away:'Querétaro', isoDate:'2026-08-16', date:'Ago 16', time:'12:00', phase:'Apertura · J4', venue:'Estadio Olímpico Universitario', city:'CDMX'},
  {id:1032, home:'América', away:'Atl. San Luis', isoDate:'2026-08-16', date:'Ago 16', time:'17:00', phase:'Apertura · J4', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1033, home:'Santos Laguna', away:'Chivas', isoDate:'2026-08-16', date:'Ago 16', time:'19:00', phase:'Apertura · J4', venue:'Estadio Corona', city:'Torreón'},
  {id:1034, home:'Tijuana', away:'Cruz Azul', isoDate:'2026-08-16', date:'Ago 16', time:'21:00', phase:'Apertura · J4', venue:'Estadio Caliente', city:'Tijuana'},
  {id:1035, home:'Necaxa', away:'León', isoDate:'2026-08-17', date:'Ago 17', time:'19:00', phase:'Apertura · J4', venue:'Estadio Victoria', city:'Aguascalientes'},
  {id:1036, home:'Pachuca', away:'Puebla', isoDate:'2026-08-17', date:'Ago 17', time:'21:00', phase:'Apertura · J4', venue:'Estadio Hidalgo', city:'Pachuca'},
  {id:1037, home:'Puebla', away:'Santos Laguna', isoDate:'2026-08-21', date:'Ago 21', time:'19:00', phase:'Apertura · J5', venue:'Estadio Cuauhtémoc', city:'Puebla'},
  {id:1038, home:'FC Juárez', away:'América', isoDate:'2026-08-21', date:'Ago 21', time:'21:00', phase:'Apertura · J5', venue:'Estadio Olímpico Benito Juárez', city:'Ciudad Juárez'},
  {id:1039, home:'Querétaro', away:'Toluca', isoDate:'2026-08-22', date:'Ago 22', time:'17:00', phase:'Apertura · J5', venue:'Estadio Corregidora', city:'Querétaro'},
  {id:1040, home:'Chivas', away:'Tijuana', isoDate:'2026-08-22', date:'Ago 22', time:'17:07', phase:'Apertura · J5', venue:'Estadio Akron', city:'Zapopan, Jalisco'},
  {id:1041, home:'León', away:'Monterrey', isoDate:'2026-08-22', date:'Ago 22', time:'19:00', phase:'Apertura · J5', venue:'Estadio León', city:'León, Guanajuato'},
  {id:1042, home:'Tigres', away:'Atlante', isoDate:'2026-08-22', date:'Ago 22', time:'21:00', phase:'Apertura · J5', venue:'Estadio Universitario', city:'San Nicolás de los Garza'},
  {id:1043, home:'Cruz Azul', away:'Atlas', isoDate:'2026-08-22', date:'Ago 22', time:'21:00', phase:'Apertura · J5', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1044, home:'Atl. San Luis', away:'Pachuca', isoDate:'2026-08-23', date:'Ago 23', time:'Por definir', phase:'Apertura · J5', venue:'Estadio Alfonso Lastras', city:'San Luis Potosí'},
  {id:1045, home:'Pumas', away:'Necaxa', isoDate:'2026-08-23', date:'Ago 23', time:'19:00', phase:'Apertura · J5', venue:'Estadio Olímpico Universitario', city:'CDMX'},
  {id:1046, home:'Atlante', away:'León', isoDate:'2026-08-30', date:'Ago 30', time:'19:00', phase:'Apertura · J6', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1047, home:'Necaxa', away:'Cruz Azul', isoDate:'2026-08-30', date:'Ago 30', time:'19:00', phase:'Apertura · J6', venue:'Estadio Victoria', city:'Aguascalientes'},
  {id:1048, home:'Tijuana', away:'Pumas', isoDate:'2026-08-30', date:'Ago 30', time:'21:00', phase:'Apertura · J6', venue:'Estadio Caliente', city:'Tijuana'},
  {id:1049, home:'Atlas', away:'Querétaro', isoDate:'2026-08-29', date:'Ago 29', time:'17:00', phase:'Apertura · J6', venue:'Estadio Jalisco', city:'Chivas'},
  {id:1050, home:'Pachuca', away:'Chivas', isoDate:'2026-08-29', date:'Ago 29', time:'17:00', phase:'Apertura · J6', venue:'Estadio Hidalgo', city:'Pachuca'},
  {id:1051, home:'América', away:'Puebla', isoDate:'2026-08-29', date:'Ago 29', time:'19:00', phase:'Apertura · J6', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1052, home:'Santos Laguna', away:'Tigres', isoDate:'2026-08-29', date:'Ago 29', time:'21:00', phase:'Apertura · J6', venue:'Estadio Corona', city:'Torreón'},
  {id:1053, home:'Toluca', away:'FC Juárez', isoDate:'2026-08-30', date:'Ago 30', time:'18:00', phase:'Apertura · J6', venue:'Estadio Nemesio Diez', city:'Toluca'},
  {id:1054, home:'Monterrey', away:'Atl. San Luis', isoDate:'2026-08-30', date:'Ago 30', time:'20:00', phase:'Apertura · J6', venue:'Estadio BBVA', city:'Guadalupe, NL'},
  {id:1055, home:'Puebla', away:'Toluca', isoDate:'2026-09-15', date:'Sep 15', time:'19:00', phase:'Apertura · J7', venue:'Estadio Cuauhtémoc', city:'Puebla'},
  {id:1058, home:'Querétaro', away:'Monterrey', isoDate:'2026-11-14', date:'Nov 14', time:'18:00', phase:'Apertura · J7', venue:'Estadio Corregidora', city:'Querétaro'},
  {id:1060, home:'América', away:'Tijuana', isoDate:'2026-10-28', date:'Oct 28', time:'22:00', phase:'Apertura · J7', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1056, home:'FC Juárez', away:'Pachuca', isoDate:'2026-09-04', date:'Sep 4', time:'21:00', phase:'Apertura · J7', venue:'Estadio Olímpico Benito Juárez', city:'Ciudad Juárez'},
  {id:1057, home:'Atl. San Luis', away:'Chivas', isoDate:'2026-09-05', date:'Sep 5', time:'17:00', phase:'Apertura · J7', venue:'Estadio Alfonso Lastras', city:'San Luis Potosí'},
  {id:1059, home:'Tigres', away:'Necaxa', isoDate:'2026-09-05', date:'Sep 5', time:'19:00', phase:'Apertura · J7', venue:'Estadio Universitario', city:'San Nicolás de los Garza'},
  {id:1061, home:'Atlas', away:'Atlante', isoDate:'2026-09-05', date:'Sep 5', time:'21:00', phase:'Apertura · J7', venue:'Estadio Jalisco', city:'Chivas'},
  {id:1062, home:'Pumas', away:'León', isoDate:'2026-09-06', date:'Sep 6', time:'12:00', phase:'Apertura · J7', venue:'Estadio Olímpico Universitario', city:'CDMX'},
  {id:1063, home:'Cruz Azul', away:'Santos Laguna', isoDate:'2026-09-06', date:'Sep 6', time:'20:00', phase:'Apertura · J7', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1064, home:'Necaxa', away:'Puebla', isoDate:'2026-09-11', date:'Sep 11', time:'19:00', phase:'Apertura · J8', venue:'Estadio Victoria', city:'Aguascalientes'},
  {id:1065, home:'Atlante', away:'Pachuca', isoDate:'2026-09-11', date:'Sep 11', time:'21:00', phase:'Apertura · J8', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1066, home:'Tijuana', away:'Querétaro', isoDate:'2026-09-11', date:'Sep 11', time:'21:00', phase:'Apertura · J8', venue:'Estadio Caliente', city:'Tijuana'},
  {id:1067, home:'Toluca', away:'Atlas', isoDate:'2026-09-12', date:'Sep 12', time:'12:00', phase:'Apertura · J8', venue:'Estadio Nemesio Diez', city:'Toluca'},
  {id:1068, home:'Cruz Azul', away:'América', isoDate:'2026-09-12', date:'Sep 12', time:'21:00', phase:'Apertura · J8', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1069, home:'León', away:'Atl. San Luis', isoDate:'2026-09-12', date:'Sep 12', time:'17:00', phase:'Apertura · J8', venue:'Estadio León', city:'León, Guanajuato'},
  {id:1070, home:'Chivas', away:'Pumas', isoDate:'2026-09-13', date:'Sep 13', time:'19:00', phase:'Apertura · J8', venue:'Estadio Akron', city:'Zapopan, Jalisco'},
  {id:1071, home:'Santos Laguna', away:'FC Juárez', isoDate:'2026-09-13', date:'Sep 13', time:'18:00', phase:'Apertura · J8', venue:'Estadio Corona', city:'Torreón'},
  {id:1072, home:'Monterrey', away:'Tigres', isoDate:'2026-09-13', date:'Sep 13', time:'20:00', phase:'Apertura · J8', venue:'Estadio BBVA', city:'Guadalupe, NL'},
  {id:1073, home:'Puebla', away:'Atlante', isoDate:'2026-09-18', date:'Sep 18', time:'19:00', phase:'Apertura · J9', venue:'Estadio Cuauhtémoc', city:'Puebla'},
  {id:1074, home:'FC Juárez', away:'Tigres', isoDate:'2026-09-18', date:'Sep 18', time:'21:00', phase:'Apertura · J9', venue:'Estadio Olímpico Benito Juárez', city:'Ciudad Juárez'},
  {id:1075, home:'Atl. San Luis', away:'Necaxa', isoDate:'2026-09-19', date:'Sep 19', time:'17:00', phase:'Apertura · J9', venue:'Estadio Alfonso Lastras', city:'San Luis Potosí'},
  {id:1076, home:'Atlas', away:'Pumas', isoDate:'2026-09-19', date:'Sep 19', time:'17:00', phase:'Apertura · J9', venue:'Estadio Jalisco', city:'Chivas'},
  {id:1077, home:'Monterrey', away:'Cruz Azul', isoDate:'2026-09-19', date:'Sep 19', time:'19:00', phase:'Apertura · J9', venue:'Estadio BBVA', city:'Guadalupe, NL'},
  {id:1078, home:'América', away:'Chivas', isoDate:'2026-09-19', date:'Sep 19', time:'21:00', phase:'Apertura · J9', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1079, home:'Toluca', away:'Santos Laguna', isoDate:'2026-09-20', date:'Sep 20', time:'18:00', phase:'Apertura · J9', venue:'Estadio Nemesio Diez', city:'Toluca'},
  {id:1080, home:'Pachuca', away:'Tijuana', isoDate:'2026-09-20', date:'Sep 20', time:'18:00', phase:'Apertura · J9', venue:'Estadio Hidalgo', city:'Pachuca'},
  {id:1081, home:'Querétaro', away:'León', isoDate:'2026-09-20', date:'Sep 20', time:'20:00', phase:'Apertura · J9', venue:'Estadio Corregidora', city:'Querétaro'},
  {id:1082, home:'Atlante', away:'Monterrey', isoDate:'2026-09-25', date:'Sep 25', time:'19:00', phase:'Apertura · J10', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1083, home:'Tijuana', away:'Atlas', isoDate:'2026-09-25', date:'Sep 25', time:'21:00', phase:'Apertura · J10', venue:'Estadio Caliente', city:'Tijuana'},
  {id:1084, home:'Chivas', away:'Querétaro', isoDate:'2026-09-26', date:'Sep 26', time:'17:07', phase:'Apertura · J10', venue:'Estadio Akron', city:'Zapopan, Jalisco'},
  {id:1085, home:'Santos Laguna', away:'Pachuca', isoDate:'2026-09-26', date:'Sep 26', time:'19:00', phase:'Apertura · J10', venue:'Estadio Corona', city:'Torreón'},
  {id:1086, home:'Tigres', away:'Puebla', isoDate:'2026-09-26', date:'Sep 26', time:'19:00', phase:'Apertura · J10', venue:'Estadio Universitario', city:'San Nicolás de los Garza'},
  {id:1087, home:'Cruz Azul', away:'Toluca', isoDate:'2026-09-26', date:'Sep 26', time:'21:00', phase:'Apertura · J10', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1088, home:'Pumas', away:'Atl. San Luis', isoDate:'2026-09-27', date:'Sep 27', time:'12:00', phase:'Apertura · J10', venue:'Estadio Olímpico Universitario', city:'CDMX'},
  {id:1089, home:'León', away:'FC Juárez', isoDate:'2026-09-27', date:'Sep 27', time:'19:00', phase:'Apertura · J10', venue:'Estadio León', city:'León, Guanajuato'},
  {id:1090, home:'Necaxa', away:'América', isoDate:'2026-09-27', date:'Sep 27', time:'21:00', phase:'Apertura · J10', venue:'Estadio Victoria', city:'Aguascalientes'},
  {id:1091, home:'Puebla', away:'León', isoDate:'2026-10-09', date:'Oct 9', time:'19:00', phase:'Apertura · J11', venue:'Estadio Cuauhtémoc', city:'Puebla'},
  {id:1092, home:'Querétaro', away:'Atlante', isoDate:'2026-10-09', date:'Oct 9', time:'19:00', phase:'Apertura · J11', venue:'Estadio Corregidora', city:'Querétaro'},
  {id:1093, home:'Tigres', away:'Toluca', isoDate:'2026-10-09', date:'Oct 9', time:'21:00', phase:'Apertura · J11', venue:'Estadio Universitario', city:'San Nicolás de los Garza'},
  {id:1094, home:'FC Juárez', away:'Tijuana', isoDate:'2026-10-10', date:'Oct 10', time:'17:00', phase:'Apertura · J11', venue:'Estadio Olímpico Benito Juárez', city:'Ciudad Juárez'},
  {id:1095, home:'Atlas', away:'Chivas', isoDate:'2026-10-10', date:'Oct 10', time:'19:00', phase:'Apertura · J11', venue:'Estadio Jalisco', city:'Chivas'},
  {id:1096, home:'América', away:'Monterrey', isoDate:'2026-10-10', date:'Oct 10', time:'21:00', phase:'Apertura · J11', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1097, home:'Pachuca', away:'Necaxa', isoDate:'2026-10-11', date:'Oct 11', time:'17:00', phase:'Apertura · J11', venue:'Estadio Hidalgo', city:'Pachuca'},
  {id:1098, home:'Atl. San Luis', away:'Santos Laguna', isoDate:'2026-10-11', date:'Oct 11', time:'17:00', phase:'Apertura · J11', venue:'Estadio Alfonso Lastras', city:'San Luis Potosí'},
  {id:1099, home:'Pumas', away:'Cruz Azul', isoDate:'2026-10-11', date:'Oct 11', time:'19:00', phase:'Apertura · J11', venue:'Estadio Olímpico Universitario', city:'CDMX'},
  {id:1100, home:'Necaxa', away:'Atlas', isoDate:'2026-10-16', date:'Oct 16', time:'19:00', phase:'Apertura · J12', venue:'Estadio Victoria', city:'Aguascalientes'},
  {id:1101, home:'Tijuana', away:'Puebla', isoDate:'2026-10-16', date:'Oct 16', time:'21:00', phase:'Apertura · J12', venue:'Estadio Caliente', city:'Tijuana'},
  {id:1102, home:'Atlante', away:'Pumas', isoDate:'2026-10-16', date:'Oct 16', time:'21:00', phase:'Apertura · J12', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1103, home:'Santos Laguna', away:'Querétaro', isoDate:'2026-10-17', date:'Oct 17', time:'17:00', phase:'Apertura · J12', venue:'Estadio Corona', city:'Torreón'},
  {id:1104, home:'Chivas', away:'Tigres', isoDate:'2026-10-17', date:'Oct 17', time:'17:07', phase:'Apertura · J12', venue:'Estadio Akron', city:'Zapopan, Jalisco'},
  {id:1105, home:'León', away:'América', isoDate:'2026-10-17', date:'Oct 17', time:'19:00', phase:'Apertura · J12', venue:'Estadio León', city:'León, Guanajuato'},
  {id:1106, home:'Toluca', away:'Atl. San Luis', isoDate:'2026-10-17', date:'Oct 17', time:'19:00', phase:'Apertura · J12', venue:'Estadio Nemesio Diez', city:'Toluca'},
  {id:1107, home:'Cruz Azul', away:'FC Juárez', isoDate:'2026-10-17', date:'Oct 17', time:'21:00', phase:'Apertura · J12', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1108, home:'Monterrey', away:'Pachuca', isoDate:'2026-10-18', date:'Oct 18', time:'19:00', phase:'Apertura · J12', venue:'Estadio BBVA', city:'Guadalupe, NL'},
  {id:1109, home:'FC Juárez', away:'Atlante', isoDate:'2026-10-20', date:'Oct 20', time:'19:00', phase:'Apertura · J13', venue:'Estadio Olímpico Benito Juárez', city:'Ciudad Juárez'},
  {id:1110, home:'Atl. San Luis', away:'Querétaro', isoDate:'2026-10-20', date:'Oct 20', time:'19:00', phase:'Apertura · J13', venue:'Estadio Alfonso Lastras', city:'San Luis Potosí'},
  {id:1111, home:'Tigres', away:'León', isoDate:'2026-10-20', date:'Oct 20', time:'21:00', phase:'Apertura · J13', venue:'Estadio Universitario', city:'San Nicolás de los Garza'},
  {id:1112, home:'Chivas', away:'Necaxa', isoDate:'2026-10-20', date:'Oct 20', time:'18:07', phase:'Apertura · J13', venue:'Estadio Akron', city:'Zapopan, Jalisco'},
  {id:1113, home:'Puebla', away:'Monterrey', isoDate:'2026-10-21', date:'Oct 21', time:'19:00', phase:'Apertura · J13', venue:'Estadio Cuauhtémoc', city:'Puebla'},
  {id:1114, home:'Atlas', away:'América', isoDate:'2026-10-21', date:'Oct 21', time:'19:00', phase:'Apertura · J13', venue:'Estadio Jalisco', city:'Chivas'},
  {id:1115, home:'Toluca', away:'Tijuana', isoDate:'2026-10-21', date:'Oct 21', time:'19:00', phase:'Apertura · J13', venue:'Estadio Nemesio Diez', city:'Toluca'},
  {id:1116, home:'Pachuca', away:'Cruz Azul', isoDate:'2026-10-21', date:'Oct 21', time:'21:00', phase:'Apertura · J13', venue:'Estadio Hidalgo', city:'Pachuca'},
  {id:1117, home:'Santos Laguna', away:'Pumas', isoDate:'2026-10-21', date:'Oct 21', time:'21:00', phase:'Apertura · J13', venue:'Estadio Corona', city:'Torreón'},
  {id:1118, home:'Necaxa', away:'FC Juárez', isoDate:'2026-10-23', date:'Oct 23', time:'19:00', phase:'Apertura · J14', venue:'Estadio Victoria', city:'Aguascalientes'},
  {id:1119, home:'Atlante', away:'Atl. San Luis', isoDate:'2026-10-23', date:'Oct 23', time:'21:00', phase:'Apertura · J14', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1120, home:'León', away:'Toluca', isoDate:'2026-10-24', date:'Oct 24', time:'17:00', phase:'Apertura · J14', venue:'Estadio León', city:'León, Guanajuato'},
  {id:1121, home:'Monterrey', away:'Chivas', isoDate:'2026-10-24', date:'Oct 24', time:'19:00', phase:'Apertura · J14', venue:'Estadio BBVA', city:'Guadalupe, NL'},
  {id:1122, home:'Pumas', away:'Tigres', isoDate:'2026-10-24', date:'Oct 24', time:'21:00', phase:'Apertura · J14', venue:'Estadio Olímpico Universitario', city:'CDMX'},
  {id:1123, home:'Atlas', away:'Puebla', isoDate:'2026-10-25', date:'Oct 25', time:'17:00', phase:'Apertura · J14', venue:'Estadio Jalisco', city:'Chivas'},
  {id:1124, home:'América', away:'Pachuca', isoDate:'2026-10-25', date:'Oct 25', time:'17:00', phase:'Apertura · J14', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1125, home:'Querétaro', away:'Cruz Azul', isoDate:'2026-10-25', date:'Oct 25', time:'19:00', phase:'Apertura · J14', venue:'Estadio Corregidora', city:'Querétaro'},
  {id:1126, home:'Tijuana', away:'Santos Laguna', isoDate:'2026-10-25', date:'Oct 25', time:'21:00', phase:'Apertura · J14', venue:'Estadio Caliente', city:'Tijuana'},
  {id:1127, home:'FC Juárez', away:'Querétaro', isoDate:'2026-10-30', date:'Oct 30', time:'19:00', phase:'Apertura · J15', venue:'Estadio Olímpico Benito Juárez', city:'Ciudad Juárez'},
  {id:1128, home:'Atl. San Luis', away:'Atlas', isoDate:'2026-10-30', date:'Oct 30', time:'19:00', phase:'Apertura · J15', venue:'Estadio Alfonso Lastras', city:'San Luis Potosí'},
  {id:1129, home:'Puebla', away:'Pumas', isoDate:'2026-10-30', date:'Oct 30', time:'21:00', phase:'Apertura · J15', venue:'Estadio Cuauhtémoc', city:'Puebla'},
  {id:1130, home:'Pachuca', away:'Tigres', isoDate:'2026-10-31', date:'Oct 31', time:'17:00', phase:'Apertura · J15', venue:'Estadio Hidalgo', city:'Pachuca'},
  {id:1131, home:'Monterrey', away:'Tijuana', isoDate:'2026-10-31', date:'Oct 31', time:'19:00', phase:'Apertura · J15', venue:'Estadio BBVA', city:'Guadalupe, NL'},
  {id:1132, home:'Chivas', away:'Atlante', isoDate:'2026-10-31', date:'Oct 31', time:'19:07', phase:'Apertura · J15', venue:'Estadio Akron', city:'Zapopan, Jalisco'},
  {id:1133, home:'América', away:'Toluca', isoDate:'2026-10-31', date:'Oct 31', time:'21:00', phase:'Apertura · J15', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1134, home:'Santos Laguna', away:'Necaxa', isoDate:'2026-11-01', date:'Nov 1', time:'17:00', phase:'Apertura · J15', venue:'Estadio Corona', city:'Torreón'},
  {id:1135, home:'Cruz Azul', away:'León', isoDate:'2026-11-01', date:'Nov 1', time:'19:00', phase:'Apertura · J15', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1136, home:'Necaxa', away:'Tijuana', isoDate:'2026-11-06', date:'Nov 6', time:'19:00', phase:'Apertura · J16', venue:'Estadio Victoria', city:'Aguascalientes'},
  {id:1137, home:'Atl. San Luis', away:'FC Juárez', isoDate:'2026-11-06', date:'Nov 6', time:'19:00', phase:'Apertura · J16', venue:'Estadio Alfonso Lastras', city:'San Luis Potosí'},
  {id:1138, home:'Atlante', away:'Santos Laguna', isoDate:'2026-11-06', date:'Nov 6', time:'21:00', phase:'Apertura · J16', venue:'Estadio Ciudad de los Deportes', city:'Benito Juárez, CDMX'},
  {id:1139, home:'Atlas', away:'Pachuca', isoDate:'2026-11-07', date:'Nov 7', time:'17:00', phase:'Apertura · J16', venue:'Estadio Jalisco', city:'Chivas'},
  {id:1140, home:'Tigres', away:'Cruz Azul', isoDate:'2026-11-07', date:'Nov 7', time:'17:00', phase:'Apertura · J16', venue:'Estadio Universitario', city:'San Nicolás de los Garza'},
  {id:1141, home:'Toluca', away:'Monterrey', isoDate:'2026-11-07', date:'Nov 7', time:'19:00', phase:'Apertura · J16', venue:'Estadio Nemesio Diez', city:'Toluca'},
  {id:1142, home:'Pumas', away:'América', isoDate:'2026-11-07', date:'Nov 7', time:'21:00', phase:'Apertura · J16', venue:'Estadio Olímpico Universitario', city:'CDMX'},
  {id:1143, home:'Querétaro', away:'Puebla', isoDate:'2026-11-08', date:'Nov 8', time:'18:00', phase:'Apertura · J16', venue:'Estadio Corregidora', city:'Querétaro'},
  {id:1144, home:'León', away:'Chivas', isoDate:'2026-11-08', date:'Nov 8', time:'20:00', phase:'Apertura · J16', venue:'Estadio León', city:'León, Guanajuato'},
  {id:1145, home:'Puebla', away:'Atl. San Luis', isoDate:'2026-11-20', date:'Nov 20', time:'19:00', phase:'Apertura · J17', venue:'Estadio Cuauhtémoc', city:'Puebla'},
  {id:1146, home:'FC Juárez', away:'Atlas', isoDate:'2026-11-20', date:'Nov 20', time:'21:00', phase:'Apertura · J17', venue:'Estadio Olímpico Benito Juárez', city:'Ciudad Juárez'},
  {id:1147, home:'Tijuana', away:'Atlante', isoDate:'2026-11-20', date:'Nov 20', time:'21:00', phase:'Apertura · J17', venue:'Estadio Caliente', city:'Tijuana'},
  {id:1148, home:'Santos Laguna', away:'León', isoDate:'2026-11-21', date:'Nov 21', time:'17:00', phase:'Apertura · J17', venue:'Estadio Corona', city:'Torreón'},
  {id:1149, home:'Pachuca', away:'Toluca', isoDate:'2026-11-21', date:'Nov 21', time:'17:00', phase:'Apertura · J17', venue:'Estadio Hidalgo', city:'Pachuca'},
  {id:1150, home:'Pumas', away:'Monterrey', isoDate:'2026-11-21', date:'Nov 21', time:'19:00', phase:'Apertura · J17', venue:'Estadio Olímpico Universitario', city:'CDMX'},
  {id:1151, home:'Tigres', away:'América', isoDate:'2026-11-21', date:'Nov 21', time:'21:00', phase:'Apertura · J17', venue:'Estadio Universitario', city:'San Nicolás de los Garza'},
  {id:1152, home:'Chivas', away:'Cruz Azul', isoDate:'2026-11-22', date:'Nov 22', time:'17:07', phase:'Apertura · J17', venue:'Estadio Akron', city:'Zapopan, Jalisco'},
  {id:1153, home:'Querétaro', away:'Necaxa', isoDate:'2026-11-22', date:'Nov 22', time:'19:00', phase:'Apertura · J17', venue:'Estadio Corregidora', city:'Querétaro'},
];

const LIGAMX_TABLA=[
  {name:'Tabla General', teams:[
    {n:'América', pj:0, g:0, e:0, p:0, gf:0, gc:0, pts:0},
    {n:'Atl. San Luis', pj:0, g:0, e:0, p:0, gf:0, gc:0, pts:0},
    {n:'Atlante', pj:0, g:0, e:0, p:0, gf:0, gc:0, pts:0},
    {n:'Atlas', pj:0, g:0, e:0, p:0, gf:0, gc:0, pts:0},
    {n:'Chivas', pj:0, g:0, e:0, p:0, gf:0, gc:0, pts:0},
    {n:'Cruz Azul', pj:0, g:0, e:0, p:0, gf:0, gc:0, pts:0},
    {n:'FC Juárez', pj:0, g:0, e:0, p:0, gf:0, gc:0, pts:0},
    {n:'León', pj:0, g:0, e:0, p:0, gf:0, gc:0, pts:0},
    {n:'Monterrey', pj:0, g:0, e:0, p:0, gf:0, gc:0, pts:0},
    {n:'Necaxa', pj:0, g:0, e:0, p:0, gf:0, gc:0, pts:0},
    {n:'Pachuca', pj:0, g:0, e:0, p:0, gf:0, gc:0, pts:0},
    {n:'Puebla', pj:0, g:0, e:0, p:0, gf:0, gc:0, pts:0},
    {n:'Pumas', pj:0, g:0, e:0, p:0, gf:0, gc:0, pts:0},
    {n:'Querétaro', pj:0, g:0, e:0, p:0, gf:0, gc:0, pts:0},
    {n:'Santos Laguna', pj:0, g:0, e:0, p:0, gf:0, gc:0, pts:0},
    {n:'Tigres', pj:0, g:0, e:0, p:0, gf:0, gc:0, pts:0},
    {n:'Tijuana', pj:0, g:0, e:0, p:0, gf:0, gc:0, pts:0},
    {n:'Toluca', pj:0, g:0, e:0, p:0, gf:0, gc:0, pts:0},
  ]}
];
...
const TORNEOS = {
  ...
  ligamxAp2026: {
    id: 'ligamxAp2026',
    nombre: 'Liga Mexicana',
    formato: 'liga',
    color: 'verde',
    partidos: LIGAMX_MATCHES,
    tabla: LIGAMX_TABLA,
    grpWin: null,
  },
};
...
function Trophy({sz=80}){
  return(
    <svg width={sz} height={sz*1.25} viewBox="0 0 80 100" fill="none"
      style={{filter:'drop-shadow(0 0 18px rgba(var(--gold-rgb),.55))'}}>
      <defs>
...
function Auth({onLogin,onLangChange=()=>{},logoutMsg='',onClearMsg=()=>{}}){
  ...
  return(
    <div style={{height:'100%',overflowY:'auto',background:`linear-gradient(180deg, rgba(4,12,30,.55), rgba(4,12,30,.8)), url('/login-bg.jpg') center/cover no-repeat fixed, #040C1E`}}>
      ...
      {logoutMsg&&(
        <div style={{margin:'0 24px 4px',background:'rgba(var(--gold-rgb),.1)',
          border:'1px solid rgba(var(--gold-rgb),.35)',borderRadius:12,
      ...
      <div style={{background:'var(--surf)',borderBottom:'1px solid var(--br)',flexShrink:0}}>
        ...
        <div style={{display:'flex',alignItems:'center',justifyContent:'center',gap:16,padding:'4px 16px 12px'}}>
          ...
          <div style={{fontFamily:'var(--ff)',fontSize:58,letterSpacing:6,color:'var(--gold)',lineHeight:1,
            textShadow:'0 0 20px rgba(var(--gold-rgb),.3)'}}>{m.hs} - {m.as}</div>
          <div style={{textAlign:'center'}}>
            ...
            {m.pre.map((q,i)=>(
              <div key={i} style={{background:'var(--surf)',borderRadius:12,padding:14,
                ...
                <div style={{fontSize:14,color:'#C8D8F0',fontStyle:'italic',lineHeight:1.6,
                  paddingLeft:12,borderLeft:'3px solid var(--gold)',background:'rgba(var(--gold-rgb),.03)',
...
function Countdown(){
  ...
  return(
    <div style={{margin:'10px 16px 14px',borderRadius:14,overflow:'hidden',
      ...
      background:'linear-gradient(135deg,rgba(var(--gold-rgb),.07) 0%,rgba(var(--gold-rgb),.02) 100%)'}}>
...
function RadialBracket({ scores }) {
  ...
  const cL_flag=64, cL_n1=175, cL_n2=262, cL_n3=340;
  const cR_flag=W-64, cR_n1=W-175, cR_n2=W-262, cR_n3=W-340;
  const cx = W/2;
  ...
  const elbow = (x1,y1,x2,y2,xmid,active) => {
    lines.push(<path key={`e${k++}`} d={`M ${x1} ${y1} L ${xmid} ${y1} L ${xmid} ${y2} L ${x2} ${y2}`} fill="none" stroke={active?GOLD:DIM} strokeWidth={active?1.6:1} opacity={active?0.85:0.4} strokeLinejoin="round"/>);
  };

  const buildSide = (side) => {
    const isL = side==='L';
    const base = isL?0:8;      // r32: izq 0-7 (ids 73-80), der 8-15 (ids 81-88)
    const r16base = isL?0:4;   // r16: izq 0-3 (89-92... no: 89,90,91,92 arriba), der 4-7
    ...
    // 16avos: home/away del slot + ganador avanza a n1
    for (let i=0;i<8;i++){
    ...
    for (let i=0;i<2;i++){
      ...
      const o1=r16S[r16base+2*i]||{}, o2=r16S[r16base+2*i+1]||{};
    ...
    const q1=qfS[qfbase]||{}, q2=qfS[qfbase+1]||{};
    elbow(n3, yqf[0], cx-95*dir, ysf, n3+off*0.9, !!q1.winner);
    elbow(n3, yqf[1], cx-95*dir, ysf, n3+off*0.9, !!q2.winner);
    return ysf;
  };
  ...
  return(
    <div className="scr fin">
      ...
      {new Date()<new Date(Date.UTC(2026,5,11,19,0,0))&&(
        <div style={{margin:'0 16px 14px',background:'rgba(var(--gold-rgb),.04)',
          borderRadius:14,border:'1px dashed rgba(var(--gold-rgb),.2)',padding:'14px 16px',
          textAlign:'center'}}>
        ...
        <div key={v.n} style={{margin:'0 16px 14px',background:'var(--surf)',
          ...
          <div style={{padding:'11px 14px',display:'flex',justifyContent:'space-between',alignItems:'center'}}>
            ...
            <div style={{fontSize:10,background:
              v.phase==='Final'?'rgba(var(--gold-rgb),.15)':
...
function BracketSlot({slot,highlight=false}){
  ...
  return(
    <div style={{background:highlight?'rgba(var(--gold-rgb),.08)':'var(--surf2)',
      borderRadius:10,border:`1px solid ${highlight?'rgba(var(--gold-rgb),.3)':'var(--br)'}`,
      padding:'8px 10px',minWidth:148,flexShrink:0,
      boxShadow:highlight?'0 0 12px rgba(var(--gold-rgb),.15)':'none'}}>
      {/* Team home */}
...
function BracketView({bracket}){
  ...
  return(
    <div style={{paddingBottom:20}}>
      {winner&&(
        <div style={{margin:'0 16px 16px',background:'linear-gradient(135deg,rgba(var(--gold-rgb),.2),rgba(var(--gold-rgb),.05))',
        ...
        <div style={{margin:'12px 16px 0'}}>
          <div className="glass" style={{background:'var(--surf)',borderRadius:'14px 14px 0 0',border:'1px solid var(--br)',borderBottom:'none',overflow:'hidden'}}>
            ...
            {ligaTeams.map((tm,i)=>{
              ...
              const zoneBg=i<4?'rgba(30,198,108,.06)':i<10?'rgba(var(--gold-rgb),.035)':'transparent';
              const dotBg=i<4?'rgba(30,198,108,.9)':i<10?'rgba(var(--gold-rgb),.28)':'rgba(255,255,255,.08)';
              return(
          ...
          <div style={{display:'flex',gap:14,justifyContent:'center',padding:'10px 8px 0',fontSize:9,color:'var(--muted)'}}>
            ...
            <span><span style={{color:'rgba(var(--gold-rgb),.7)'}}>●</span> Play-in (5-10)</span>
          </div>
        </div>
      </div>
    );
        ...
        <div style={{background:'var(--surf)',borderRadius:'14px 14px 0 0',border:'1px solid var(--br)',borderBottom:'none'}}>
          ...
          {sorted.map((t,i)=>{
            ...
            return(
              <div key={t.n} style={{display:'grid',gridTemplateColumns:'24px 30px repeat(8,1fr)',gap:0,
                ...
                background:i===0?'rgba(var(--gold-rgb),.04)':i===1?'rgba(30,198,108,.03)':'transparent',
                transition:'background .15s'}}>
                {/* Posición */}
                <div style={{width:20,height:20,borderRadius:'50%',
                  background:i===0?'var(--gold)':i===1?'rgba(var(--gold-rgb),.22)':'rgba(255,255,255,.08)',
                  display:'flex',alignItems:'center',justifyContent:'center',
          ...
          {showName&&(
            <div style={{padding:'8px 14px',borderTop:'1px solid rgba(255,255,255,.05)',
              background:'rgba(var(--gold-rgb),.06)',fontSize:12,color:'var(--gold)',fontWeight:600,
    ...
    return(
      <div onClick={()=>setSel(active?null:p.n)}
        style={{display:'flex',alignItems:'center',gap:12,
          background:active?'rgba(var(--gold-rgb),.08)':'var(--surf)',
      ...
      <div style={{padding:'0 12px 24px'}}>
        {!anyGoals&&(
          <div style={{fontSize:11,color:'var(--muted)',textAlign:'center',
            marginBottom:12,padding:'8px',background:'rgba(var(--gold-rgb),.05)',
            borderRadius:8,border:'1px solid rgba(var(--gold-rgb),.12)'}}>
      ...
      {selPlayer&&(
        <div
          ...
          <div
            ...
            {/* Header bio */}
            <div style={{padding:'14px 16px 12px',background:'rgba(var(--gold-rgb),.07)',
        ...
        <div onClick={e=>e.stopPropagation()}
          ...
          <div style={{display:'flex',gap:10}}>
            ...
            <button onClick={handleOk} disabled={busy}
              style={{flex:1,background:'rgba(var(--gold-rgb),.15)',border:'1px solid rgba(var(--gold-rgb),.4)',
...
function AdminResultados({onClose}){
  ...
  // Al abrir el panel, SIEMPRE sincronizar goleadores desde el servidor (fuente de verdad)
  useEffect(()=>{
  ...
  return(
    <div className="scr fin">
      <div style={{padding:'28px 16px 20px',
        background:`linear-gradient(180deg,${user.isAdmin?'rgba(var(--gold-rgb),.14)':'rgba(var(--gold-rgb),.07)'} 0%,transparent 100%)`,
        textAlign:'center',borderBottom:'1px solid rgba(255,255,255,.05)'}}>
        <div style={{width:78,height:78,borderRadius:'50%',
          background:user.isAdmin?'linear-gradient(135deg,var(--gold),#FF8C00)':'linear-gradient(135deg,var(--gold),var(--gold2))',
          margin:'0 auto 12px',display:'flex',alignItems:'center',justifyContent:'center',
          fontFamily:'var(--ff)',fontSize:user.isAdmin?34:36,color:'#000',
          boxShadow:`0 0 0 4px rgba(var(--gold-rgb),${user.isAdmin?.35:.15})`}}>
          {user.isAdmin?'👑':ini}
        </div>
        ...
        {user.isAdmin?(
          <div style={{display:'inline-flex',alignItems:'center',gap:7,marginTop:8,
            background:'rgba(var(--gold-rgb),.12)',borderRadius:20,padding:'5px 16px',
          ...
          <div style={{marginBottom:16}}>
            ...
            <button onClick={()=>setShowResultados(true)}
              style={{width:'100%',background:'linear-gradient(135deg,var(--gold),var(--gold2))',
                ...
                cursor:'pointer',marginBottom:14,boxShadow:'0 3px 14px rgba(var(--gold-rgb),.3)'}}>
            ...
            <div style={{background:'var(--surf)',borderRadius:12,border:'1px solid var(--br)',
              ...
              {dbLoaded&&dbUsers.map((u,i)=>(
                <div key={u.id||i} style={{
                  ...
                  background:u.paquetes>0?'rgba(var(--gold-rgb),.02)':'transparent'}}>
                  {/* Fila 1: avatar + nombre + correo (ancho completo) */}
                  <div style={{display:'flex',alignItems:'center',gap:7,marginBottom:3}}>
                    <div style={{width:24,height:24,borderRadius:'50%',flexShrink:0,
                      background:u.paquetes>0?'rgba(var(--gold-rgb),.15)':'rgba(79,142,247,.12)',
                      border:`1.5px solid ${u.paquetes>0?'rgba(var(--gold-rgb),.3)':'rgba(79,142,247,.25)'}`,
                      display:'flex',alignItems:'center',justifyContent:'center',
                    ...
                    <div style={{flex:1,minWidth:0}}>
                      <div style={{fontSize:11,fontWeight:700,color:'var(--txt)',lineHeight:1.2}}>
                        {u.name||'Sin nombre'}
                        {u.gifted&&<span style={{marginLeft:4,fontSize:8,background:'rgba(var(--gold-rgb),.2)',
                  ...
                  <div style={{display:'flex',alignItems:'center',gap:8,paddingLeft:38}}>
                    ...
                    <button
                      ...
                      style={{width:28,flexShrink:0,
                        background:u.gifted?'rgba(30,198,108,.15)':'rgba(var(--gold-rgb),.12)',
                        border:`1px solid ${u.gifted?'rgba(30,198,108,.3)':'rgba(var(--gold-rgb),.3)'}`,
        ...
        <div style={{margin:'0 0 14px',background:'var(--surf)',borderRadius:14,
          ...
          {!true&&(
            <div style={{fontSize:12,color:'var(--dim)',lineHeight:1.6}}>
              ...
              <code style={{background:'rgba(var(--gold-rgb),.1)',padding:'3px 8px',borderRadius:4,
...
function GruposScreen({user,userBets,credito,creditoLoading,onPagar,onRecheckAccess,torneoId=''}){
  ...
  const DEMO_GROUP={
    ...
    ownerId:'dm1',
    members:[
      {id:'dm1', name:'Carlos García',    ini:'C', col:'var(--gold)', pts:247, locked:true, lockedAt:Date.now()-86400000*8, bets:[], correct:62, total:72},
            ...
            <div style={{overflowY:'auto',flex:1}}>
              ...
              {membersModal.allM.map((m,i)=>(
                <div key={m.id} style={{display:'flex',alignItems:'center',gap:10,
                  ...
                  background:m.id==='user'?'rgba(var(--gold-rgb),.03)':'transparent'}}>
                  {/* Posición */}
                  ...
                  <div style={{flex:1,minWidth:0}}>
                    <div style={{fontSize:13,fontWeight:700,overflow:'hidden',
                      ...
                      {m.name}
                      {m.id==='user'&&<span style={{fontSize:8,background:'rgba(var(--gold-rgb),.15)',
                ...
                <div key={m.id} className={i===0?'leader-glow':''} style={{padding:'10px 16px',borderBottom:i===0?'none':'1px solid rgba(255,255,255,.04)',
                  ...
                  <div style={{display:'flex',alignItems:'center',gap:10}}>
                    ...
                    <div style={{width:28,height:28,borderRadius:'50%',flexShrink:0,
                      background:i===0?'rgba(var(--gold-rgb),.3)':i===1?'rgba(192,192,192,.2)':i===2?'rgba(205,127,50,.2)':'rgba(255,255,255,.07)',
          ...
          {dtab==='pronosticos'&&(
            <div style={{padding:'12px 16px'}}>
              {locked?(
                ...
                <div>
                  <div style={{background:'rgba(var(--gold-rgb),.07)',border:'1px solid rgba(var(--gold-rgb),.2)',
            ...
            <div>
              ...
              {allM.map((m,rank)=>(
                <div key={m.id} style={{margin:'8px 16px',background:'var(--surf)',borderRadius:14,
                  border:`1.5px solid ${m.id==='user'?'rgba(var(--gold-rgb),.3)':'var(--br)'}`,overflow:'hidden'}}>
                  <div style={{padding:'10px 14px',borderBottom:'1px solid var(--br)',
                    display:'flex',alignItems:'center',gap:10,
                    background:m.id==='user'?'rgba(var(--gold-rgb),.04)':'rgba(255,255,255,.015)'}}>
                    ...
                    {preds.map(({m,b})=>{
                      ...
                      return(
                        <div key={m.id} style={{display:'flex',alignItems:'center',gap:9,
                          ...
                          background:isUser?'rgba(var(--gold-rgb),.025)':'transparent'}}>
              ...
              <div style={{background:'var(--surf)',borderRadius:12,padding:14,border:'1px solid var(--br)'}}>
                ...
                {[['1','Cada miembro va a la sección 🎰 Apuestas y hace sus pronósticos'],
                  ...
                  <div key={n} style={{display:'flex',gap:10,padding:'8px 0',
                    borderBottom:'1px solid rgba(255,255,255,.04)',alignItems:'flex-start'}}>
                    <div style={{width:22,height:22,borderRadius:'50%',background:'rgba(var(--gold-rgb),.15)',
                      display:'flex',alignItems:'center',justifyContent:'center',
...
function PagoScreen({onExito,onCancelar,esReset=false,onRecheckAccess,user,onRecover}){
  ...
  if(exito)return(
    <div style={{display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',
      ...
      <div style={{background:'rgba(var(--gold-rgb),.1)',borderRadius:14,padding:'14px 24px',
        border:'1px solid rgba(var(--gold-rgb),.25)'}}>
  ...
  return(
    <div className="scr fin">
      ...
      <div style={{padding:'18px 16px 14px',
        background:'linear-gradient(180deg,rgba(var(--gold-rgb),.07) 0%,transparent 100%)',
        ...
        <div style={{background:'var(--surf)',borderRadius:14,padding:'16px',
          border:'1.5px solid rgba(var(--gold-rgb),.3)',display:'flex',justifyContent:'space-between',
          alignItems:'center'}}>
          <div>
                ...
                {[['card','💳',t.pg_card],['oxxo','🏪',t.pg_oxxo]].map(([m,ic,lb])=>(
                  <button key={m} onClick={()=>setMetodo(m)}
                    style={{flex:1,padding:'10px 4px',
                      ...
                      border:`1.5px solid ${metodo===m?'rgba(var(--gold-rgb),.4)':'var(--br)'}`,
              ...
              {metodo==='oxxo'&&(
                <div style={{background:'var(--surf)',borderRadius:12,padding:16,
                  ...
                  <div style={{marginTop:10,fontSize:11,color:'var(--dim)',
                    background:'rgba(var(--gold-rgb),.05)',borderRadius:8,padding:'8px'}}>
              ...
              return(
                <div key={id}>
                      ...
                      {[{val:'home',team:home,odds:o1},{val:'away',team:away,odds:o2}].map(({val,team,odds})=>{
                        ...
                        return(
                          <button type="button" key={val}
                            onClick={matchLocked(id)?undefined:e=>{e.preventDefault();placeElim(id,val,odds);}}
                            style={{background:sel?'rgba(var(--gold-rgb),.18)':'var(--surf2)',
                              border:`1.5px solid ${sel?'var(--gold)':'var(--br)'}`,
                              borderRadius:10,padding:'7px 4px',
                              cursor:matchLocked(id)?'default':'pointer',
                              display:'flex',flexDirection:'column',alignItems:'center',gap:1,
                              transition:'background .15s,border-color .15s',
                              opacity:matchLocked(id)&&!sel?0.45:1}}>
                  ...
                  {isFinal&&!matchLocked(104)&&!bloqueada&&(
                    <div style={{padding:'11px 14px',background:'rgba(var(--gold-rgb),.04)',
                      borderTop:'1px solid rgba(var(--gold-rgb),.15)'}}>
                      ...
                      <div style={{display:'flex',alignItems:'center',gap:8}}>
                        <input type="text" inputMode="numeric" maxLength={1} placeholder="0" value={exacto.h}
                          ...
                          style={{width:48,padding:'8px 4px',background:'var(--surf2)',
                            border:'1.5px solid rgba(var(--gold-rgb),.4)',borderRadius:10,
                  ...
                  {isFinal&&(matchLocked(104)||bloqueada)&&bet.exacto&&(
                    <div style={{padding:'8px 14px',background:'rgba(var(--gold-rgb),.04)',
                      borderTop:'1px solid rgba(var(--gold-rgb),.15)',fontSize:11,color:'var(--gold)'}}>
              ...
              <div style={{padding:'10px 12px',borderTop:'1px solid rgba(255,255,255,.05)'}}>
                <button type="button" onClick={()=>handleSave(ids)} disabled={saving}
                  style={{width:'100%',background:'linear-gradient(135deg,var(--gold),var(--gold2))',
                    ...
                    letterSpacing:.5,boxShadow:'0 3px 12px rgba(var(--gold-rgb),.3)'}}>
...
function BetsScreen({torneo,bets,placeBet,credito,creditoLoading,onPagar,onReset,betsSaved=false,onSave,onEditPredictions,currentUser,onRecheckAccess,onRecover,elimBets={},setElimBets=()=>{},ligaBets={},placeBetLiga=()=>{}}){
  ...
  const BetResult=({betId})=>{
    ...
    if(!b) return null;
    return(
      <div style={{margin:'6px 0 0',padding:'7px 10px',background:'rgba(var(--gold-rgb),.05)',borderRadius:8,fontSize:12,color:'var(--dim)',display:'flex',justifyContent:'space-between'}}>
  ...
  const Especiales=()=>(
    <div>
      ...
      <div style={{margin:'0 16px 16px',background:'var(--surf)',borderRadius:14,
        border:'2px solid rgba(var(--gold-rgb),.3)',overflow:'hidden'}}>
        <div style={{padding:'11px 14px',background:'rgba(var(--gold-rgb),.06)',
          borderBottom:'1px solid rgba(var(--gold-rgb),.2)',display:'flex',alignItems:'center',gap:8}}>
            ...
            <div style={{padding:'12px 14px',borderBottom:'1px solid rgba(255,255,255,.05)'}}>
              ...
              <div style={{display:'flex',alignItems:'center',gap:8}}>
                ...
                <button
                  ...
                  style={{flex:1,background:'rgba(var(--gold-rgb),.1)',border:'1px solid rgba(var(--gold-rgb),.3)',
    ...
    <div className="scr fin">
      ...
      <div style={{padding:'14px 16px 10px',borderBottom:'1px solid rgba(255,255,255,.04)',
        ...
        <div style={{background:'var(--surf)',borderRadius:12,padding:'11px 13px',
          border:`1px solid ${isAdminUser?'rgba(var(--gold-rgb),.4)':'var(--br)'}`}}>
          {isAdminUser?(
            <div style={{display:'flex',alignItems:'center',gap:10}}>
        ...
        <div style={{margin:'4px 16px 0',display:'flex',gap:8,alignItems:'center'}}>
          ...
          <button onClick={()=>{if(totalCoins>=COINS_PER_PAGO){onEditPredictions&&onEditPredictions();}}}
            ...
            style={{background:totalCoins<COINS_PER_PAGO?'rgba(120,120,120,.2)':'linear-gradient(135deg,var(--gold),var(--gold2))',
              ...
              boxShadow:totalCoins<COINS_PER_PAGO?'none':'0 3px 12px rgba(var(--gold-rgb),.3)'}}>
            ✏️ Modificar
          </button>
        </div>
      )}
      ...
      {(
        <div style={{margin:'8px 16px 24px',padding:'16px',background:'var(--surf)',
          borderRadius:16,border:`2px solid ${betsSaved?'var(--grn)':coinsLeft<=0?'rgba(var(--gold-rgb),.5)':'var(--br)'}`,
          textAlign:'center'}}>
            ...
            <div>
              ...
              <button onClick={()=>{if(totalCoins>=COINS_PER_PAGO){onEditPredictions&&onEditPredictions();}}}
                ...
                style={{width:'100%',background:totalCoins<COINS_PER_PAGO?'rgba(120,120,120,.2)':'linear-gradient(135deg,var(--gold),var(--gold2))',
                  ...
                  opacity:totalCoins<COINS_PER_PAGO?0.5:1,
                  boxShadow:totalCoins<COINS_PER_PAGO?'none':'0 4px 16px rgba(var(--gold-rgb),.35)'}}>
                {totalCoins<COINS_PER_PAGO?'🔒 Compra un paquete para modificar':'✏️ Modificar pronósticos'}
              </button>
              <div style={{background:'rgba(var(--gold-rgb),.06)',borderRadius:12,
                border:'1px solid rgba(var(--gold-rgb),.18)',padding:'10px 12px',marginBottom:12}}>
              ...
              <button onClick={()=>setShowAddPackage(true)}
                style={{width:'100%',background:'rgba(var(--gold-rgb),.1)',
                  border:'1px solid rgba(var(--gold-rgb),.3)',color:'var(--gold)',
            ...
            <div>
              ...
              <button
                ...
                style={{width:'100%',
                  ...
                  boxShadow:canSave&&bets.length>0?'0 4px 20px rgba(var(--gold-rgb),.4)':'none',
        ...
        <div style={{margin:'0 16px 14px'}}>
          ...
          {Object.entries(byCategory).map(([cat,data])=>(
            <div key={cat} style={{display:'flex',alignItems:'center',gap:10,padding:'9px 14px',
              ...
              {data.pend>0&&<span style={{fontSize:10,background:'rgba(var(--gold-rgb),.1)',color:'var(--gold)',padding:'2px 7px',borderRadius:20}}>⏳ {data.pend}</span>}
            </div>
          ))}
        </div>
      )}
...
export default function App(){
  ...
  const login=async u=>{
    ...
    try{
      ...
      const checkFirestoreCredit=async(attempts=0)=>{
        ...
        if(getOneFn){
          try{
            // Leer el doc REAL: users/{Firebase Auth uid} (el id local puede ser legacy)
            const authUid=(window._fbCurrentUid&&window._fbCurrentUid())||u.id;
  ...
  const logout=(reason='')=>{
    ...
    // Limpiar cache local para que el próximo login lea de Firestore, no de datos viejos
    try{localStorage.removeItem('wc2026_current_user');}catch(e){}
    try{localStorage.removeItem('wc2026_users_db');}catch(e){}     // DB_KEY (cache de usuarios por email)
    ...
    <div>
      ...
      <div className={'app'+(screen==='app'&&TORNEOS[torneoActivo]?.formato==='liga'?' theme-liga':'')} style={screen==='app'?(THEMES[torneoActivo]||{}):{}}>
        ...
        <svg className="bg-shapes" style={{position:'absolute',top:0,left:0,width:'100%',height:'100%',pointerEvents:'none',zIndex:-1}} viewBox="0 0 430 900" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
          ...
          <circle cx="158" cy="296" r="3.5" fill="var(--gold)" opacity="0.11"/>
          <circle cx="332" cy="418" r="5" fill="var(--gold)" opacity="0.12"/>
          <circle cx="332" cy="418" r="10" fill="var(--gold)" opacity="0.05"/>
          <circle cx="272" cy="528" r="3" fill="var(--gold)" opacity="0.10"/>
          <circle cx="88" cy="594" r="4.5" fill="var(--gold)" opacity="0.11"/>
          <circle cx="385" cy="464" r="3.5" fill="var(--gold)" opacity="0.10"/>
          <circle cx="385" cy="464" r="8" fill="var(--gold)" opacity="0.04"/>
          <circle cx="214" cy="658" r="2.5" fill="var(--gold)" opacity="0.09"/>
          <circle cx="46" cy="720" r="3" fill="var(--gold)" opacity="0.08"/>
          <circle cx="394" cy="314" r="3.5" fill="var(--gold)" opacity="0.10"/>
          <circle cx="180" cy="726" r="2.5" fill="var(--gold)" opacity="0.08"/>
              ...
              const svgIcon=id==='pronostico'?(
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                  <path d="M8 21h8M12 17v4M5 3H3v3c0 2.21 1.79 4 4 4M19 3h2v3c0 2.21-1.79 4-4 4"
                    stroke={isActive?'var(--gold)':'var(--gold-dim)'} strokeWidth="2" strokeLinecap="round"/>
                  <path d="M12 17c-3.87 0-7-3.13-7-7V3h14v7c0 3.87-3.13 7-7 7z"
                    fill={isActive?'rgba(var(--gold-rgb),.25)':'rgba(var(--gold-dim-rgb),.12)'}
                    stroke={isActive?'var(--gold)':'var(--gold-dim)'} strokeWidth="2"/>
                  <circle cx="12" cy="8" r="2" fill={isActive?'var(--gold)':'var(--gold-dim)'}/>
                </svg>
              ):(
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                  ...
                  <circle cx="12" cy="4" r="1.5" fill={isActive?'var(--gold)':'var(--gold-dim)'}/>
                  <circle cx="3" cy="8" r="1.5" fill={isActive?'var(--gold)':'var(--gold-dim)'}/>
                  <circle cx="21" cy="8" r="1.5" fill={isActive?'var(--gold)':'var(--gold-dim)'}/>
                </svg>
              );
              return(
                <div key={id} onClick={()=>{if(id==='selector'){setTab('home');setScreen('selector');}else{setTab(id);}}}
                  style={{display:'flex',flexDirection:'column',alignItems:'center',
                    justifyContent:'center',flex:1,cursor:'pointer',gap:2,
                    position:'relative',paddingTop:isPremium?2:0}}>
                  {isPremium&&(
                    <div style={{position:'absolute',top:-1,left:'50%',transform:'translateX(-50%)',
                      background:credito?'linear-gradient(90deg,var(--gold),var(--gold2))':'rgba(100,100,100,.8)',
                      borderRadius:'0 0 8px 8px',padding:'1px 10px',
                      fontSize:8,fontWeight:800,letterSpacing:.5,color:credito?'#000':'#fff',
                      boxShadow:credito?'0 2px 8px rgba(var(--gold-rgb),.4)':'none'}}>
                      {credito?'VIP':'🔒'}
                    </div>
                  )}
                  <div style={{
                    ...
                    background:isPremium
                      ?(isActive?'rgba(var(--gold-rgb),.18)':'rgba(var(--gold-dim-rgb),.08)')
                      :'transparent',
                    border:isPremium
                      ?`1.5px solid ${isActive?'rgba(var(--gold-rgb),.6)':'rgba(var(--gold-dim-rgb),.3)'}`
                      :'none',
                    transition:'all .2s',
                    boxShadow:isPremium&&isActive?'0 0 12px rgba(var(--gold-rgb),.35)':'none',
                  }}>
                    {isPremium ? svgIcon
                  ...
                  <div style={{
                    ...
                    color:isPremium?(isActive?'var(--gold)':'var(--gold-text-dim)'):(isActive?'var(--gold)':'var(--muted)'),
